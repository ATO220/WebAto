...
<div class="container">
					...
					<div id="carrusel-img" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								<img src="img/img-slider/imagen2.jpg" alt="imagen2" class="d-block w-100 pb-image bg-white">
								<div class="carousel-caption">
									<h5 class="text-responsive">Diseño Responsive</h5>
    ...
    <div class="contacto border-info pt-xl-4 mt-xl-5 mb-xl-5 pb-xl-3 pt-2">
        ...
        <form action="enviar.php" class="pl-lg-4 pr-lg-4 m-5" method="post" name="myForm" id="formContacto">
            <div class="form-row">
		...
		<div class="comntainer ml-5 pl-lg-4">
